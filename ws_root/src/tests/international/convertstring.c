...
unichar unicode[200];
    ...
    {
        result = intlConvertString(badItems[i].it_Item,(unichar *)"\000", buffer, 2, 0);
    ...
    {
        result = intlConvertString(locItem,(unichar *)badSources[i].bp_Ptr,(unichar *)"\000",2,0);
    ...
    {
        result = intlConvertString(locItem,(unichar *)"\000",(unichar *)badResults[i].bp_Ptr,2,0);
    ...
    {
        result = intlConvertString(locItem,(unichar *)"\000",buffer,badResultSizes[i].bp_Ptr,0);
