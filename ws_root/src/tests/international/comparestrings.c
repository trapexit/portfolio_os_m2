...
unichar buf2[200];
    ...
    {
        result = intlCompareStrings(badItems[i].it_Item,(unichar *)"\000",(unichar *)"\000");
    ...
    {
        result = intlCompareStrings(locItem,(unichar *)badSources[i].bp_Ptr,(unichar *)"\000");
    ...
    for (i = 0; i < NUM_BADSOURCES; i++)
    {
        result = intlCompareStrings(locItem,(unichar *)"\000",(unichar *)badSources[i].bp_Ptr);
