...
begincode:
		...
		addi		pxdata,pxformbase,(2*xformen)		/* pxdata is same reg as pgeometry! */
xformlooptop:
		...
		stfs		fxpp0,xformen.xpp-(2*xformen)(pxdata)
		stfs		fypp0,xformen.ypp-(2*xformen)(pxdata)
		stfs		fwinv0,xformen.winv-(2*xformen)(pxdata)
		stfs		fxpp1,xformen.xpp-xformen(pxdata)
		stfs		fypp1,xformen.ypp-xformen(pxdata)
		stfs		fwinv1,xformen.winv-xformen(pxdata)

		bf		clipFLAG,.loadrgb

/* if clipping, store pre-projected points and check clip bounds */

		stfs		fxp0,xformen.xp-(2*xformen)(pxdata)
		stfs		fyp0,xformen.yp-(2*xformen)(pxdata)
		stfs		fwp0,xformen.wp-(2*xformen)(pxdata)
		stfs		fxp1,xformen.xp-xformen(pxdata)
		stfs		fyp1,xformen.yp-xformen(pxdata)
		stfs		fwp1,xformen.wp-xformen(pxdata)
		...
		stw		clip0,xformen.flags-(2*xformen)(pxdata)
		stw		clip1,xformen.flags-xformen(pxdata)
.loadrgb:
	...
	DECFN	M_LightReturnDynLitEnv
		...
		stfs		fracc0,xformen.r-(2*xformen)(pxdata)
		stfs		fgacc0,xformen.g-(2*xformen)(pxdata)
		stfs		fbacc0,xformen.b-(2*xformen)(pxdata)
		stfs		faacc0,xformen.a-(2*xformen)(pxdata)
		stfs		fu0,xformen.u-(2*xformen)(pxdata)
		stfs		fv0,xformen.v-(2*xformen)(pxdata)

		stfs		fracc1,xformen.r-xformen(pxdata)
		stfs		fgacc1,xformen.g-xformen(pxdata)
		stfs		fbacc1,xformen.b-xformen(pxdata)
		stfs		faacc1,xformen.a-xformen(pxdata)
		stfs		fu1,xformen.u-xformen(pxdata)
		stfs		fv1,xformen.v-xformen(pxdata)

		addi		pxdata,pxdata,(2*xformen)
		bdnz		xformlooptop
...
.sharedloop:
		...
		mulli		pxvert,pxvert,xformen
		mulli		pxcol,pxcol,xformen
		add		pxvert,pxvert,pxformbase
		add		pxcol,pxcol,pxformbase

		lfs		fxpp0,xformen.xpp(pxvert)
		lfs		fypp0,xformen.ypp(pxvert)
		lfs		fwinv0,xformen.winv(pxvert)

		bf		clipFLAG,.storesharedrgb

		lfs		fxp0,xformen.xp(pxvert)
		lfs		fyp0,xformen.yp(pxvert)
		lfs		fwp0,xformen.wp(pxvert)
		lwz		clip0,xformen.flags(pxvert)
...
.storesharedrgb:
		...
		stfs		fypp0,xformen.ypp-(2*xformen)(pxdata)
		stfs		fwinv0,xformen.winv-(2*xformen)(pxdata)
		lfs		fracc0,xformen.r(pxcol)
		lfs		fgacc0,xformen.g(pxcol)
		lfs		fbacc0,xformen.b(pxcol)
		lfs		faacc0,xformen.a(pxcol)
		lfs		fu0,xformen.u(pxvert)
		lfs		fv0,xformen.v(pxvert)
		stfs		fracc0,xformen.r-(2*xformen)(pxdata)
		stfs		fgacc0,xformen.g-(2*xformen)(pxdata)
		stfs		fbacc0,xformen.b-(2*xformen)(pxdata)
		stfs		faacc0,xformen.a-(2*xformen)(pxdata)
 ...
 ***************************************************/
.startpass2:
		lfs		fconst0pt5,CloseData.fconst0pt5_off(pclosedata)
		lfs		fconst1pt0,CloseData.fconst1pt0_off(pclosedata)
		...
		mulli		nextvtxoffset,nextvtxoffset,xformen
/*
...
alldone:
		...
		blr
selecttexture:
/*	Always select snippet 0 because environment maps only have one texture in the page */
		/* li		itemp0, 0 */
...
notextureselect:
		...
		lhau		itemp0,2(pindex)
		mulli		vtxoffset1,vtxoffset1,xformen
		andi.		nextvtxoffset,itemp0,0x7ff
		mulli		nextvtxoffset,nextvtxoffset,xformen
		add		vtxoffset1,vtxoffset1,pxformbase

		lfs		fdu0,xformen.u(vtxoffset0)
		lfs		fdv0,xformen.v(vtxoffset0)
		lfs		fdu1,xformen.u(vtxoffset1)
		lfs		fdv1,xformen.v(vtxoffset1)
		lfs		fdxp0,xformen.xpp(vtxoffset0)
		lfs		fdyp0,xformen.ypp(vtxoffset0)
		lfs		fdxp1,xformen.xpp(vtxoffset1)
		lfs		fdyp1,xformen.ypp(vtxoffset1)
		lwz		iclipflags0,xformen.flags(vtxoffset0)
		lwz		iclipflags1,xformen.flags(vtxoffset1)
...
load2:
		...
		lfs		fdxp2,xformen.xpp(vtxoffset2)
		lfs		fdyp2,xformen.ypp(vtxoffset2)
		lwz		iclipflags2,xformen.flags(vtxoffset2)

		lfs		fdu2,xformen.u(vtxoffset2)
		lfs		fdv2,xformen.v(vtxoffset2)
loadcont:
		dcbt		pVI,tloffset
...
draw0:	
		lfs		fdwinv,xformen.winv(vtxoffset0)
		fmuls		fdu,fdu0,fdwinv
		fmuls		fdv,fdv0,fdwinv
		fmuls		fdu,fdu,fduscale
		fmuls		fdv,fdv,fdvscale
		lfs		fdtemp0,xformen.r(vtxoffset0)
		lfs		fdtemp1,xformen.g(vtxoffset0)
		lfs		fdtemp2,xformen.b(vtxoffset0)
		lfs		fdtemp3,xformen.a(vtxoffset0)
...
draw1:	
		lfs		fdwinv,xformen.winv(vtxoffset1)
		fmuls		fdu,fdu1,fdwinv
		fmuls		fdv,fdv1,fdwinv
		fmuls		fdu,fdu,fduscale
		fmuls		fdv,fdv,fdvscale
		lfs		fdtemp0,xformen.r(vtxoffset1)
		lfs		fdtemp1,xformen.g(vtxoffset1)
		lfs		fdtemp2,xformen.b(vtxoffset1)
		lfs		fdtemp3,xformen.a(vtxoffset1)
...
draw2:	
		lfs		fdwinv,xformen.winv(vtxoffset2)
		fmuls		fdu,fdu2,fdwinv
		fmuls		fdv,fdv2,fdwinv
		fmuls		fdu,fdu,fduscale
		fmuls		fdv,fdv,fdvscale
		lfs		fdtemp0,xformen.r(vtxoffset2)
		lfs		fdtemp1,xformen.g(vtxoffset2)
		lfs		fdtemp2,xformen.b(vtxoffset2)
		lfs		fdtemp3,xformen.a(vtxoffset2)
...
wrap:
		fsubs		fdtemp0,fdu0,fdu1
		fsubs		fdtemp1,fdu0,fdu2
		fsubs		fdtemp2,fdu1,fdu2
		fabs		fdtemp0,fdtemp0
		fabs		fdtemp1,fdtemp1
		fabs		fdtemp2,fdtemp2
		fcmpu		1,fdtemp0,fconst0pt5
		fcmpu		2,fdtemp1,fconst0pt5
		fcmpu		3,fdtemp2,fconst0pt5
		bge		1,wrapGE
		bge		2,wrapGE
		btlr		cr3lt
wrapGE:
...
wrap0entry:
		fcmpu		1,fdu2,fdu0
		blt		1,wrap_add0
		fadds		fdu0,fdu0,fconst1pt0
		fadds		fdu1,fdu1,fconst1pt0
		blr
wrap_add0:
		fadds		fdu2,fdu2,fconst1pt0
		crclr		cr1lt
		blr
wrap1:
		bf		cr2lt,wrap2
...
clip:	
		...
		mflr		savelr
		bl		wrap
		stfs		fdu0,CloseData.clipdata_off+(33*4)(pclosedata)
		stfs		fdv0,CloseData.clipdata_off+(34*4)(pclosedata)
		stfs		fdu1,CloseData.clipdata_off+(35*4)(pclosedata)
		stfs		fdv1,CloseData.clipdata_off+(36*4)(pclosedata)
		stfs		fdu2,CloseData.clipdata_off+(37*4)(pclosedata)
		stfs		fdv2,CloseData.clipdata_off+(38*4)(pclosedata)
		li		int_one,1
 ...
 */
		...
		lfs		fcuc,CloseData.clipdata_off+(33*4)(pclosedata)
		lfs		fcvc,CloseData.clipdata_off+(34*4)(pclosedata)
		bl		.copyverts
		mr		srcptr,vtxoffset1
		lfs		fcuc,CloseData.clipdata_off+(35*4)(pclosedata)
		lfs		fcvc,CloseData.clipdata_off+(36*4)(pclosedata)
		bl		.copyverts
		mr		srcptr,vtxoffset2
		lfs		fcuc,CloseData.clipdata_off+(37*4)(pclosedata)
		lfs		fcvc,CloseData.clipdata_off+(38*4)(pclosedata)
		bl		.copyverts
/*
 *	wmin clip
...
.build:
		...
		bl		.swap
		lfs		fduscale,CloseData.float13(pclosedata)
		lfs		fdvscale,CloseData.float14(pclosedata)
.build_loop:
		lwzu		newptr,4(srcptr)
		...
		fmuls		fcu0,fcu0,fduscale
		fmuls		fcv0,fcv0,fdvscale
		stfsu		fcx0,4(pVI)
		stfsu		fcy0,4(pVI)
		stfsu		fcr0,4(pVI)
		stfsu		fcg0,4(pVI)
 ...
 */
.copyverts:
		lfs		fcxc,xformen.xp(srcptr)
		lfs		fcyc,xformen.yp(srcptr)
		lfs		fcwc,xformen.wp(srcptr)
		lfs		fcrc,xformen.r(srcptr)
		lfs		fcgc,xformen.g(srcptr)
		lfs		fcbc,xformen.b(srcptr)
		lfs		fcac,xformen.a(srcptr)
		lwz		flags,xformen.flags(srcptr)
/*
