...
aasetcolordone:
		lfs		fu0aa,0(puv0AA)
		lfs		fv0aa,4(puv0AA)
		fmuls		fu0aa,fu0aa,fduscale
		fmuls		fv0aa,fv0aa,fdvscale
		fmuls		fu0aa,fu0aa,fw0aa
		fmuls		fv0aa,fv0aa,fw0aa

		lfs		fu1aa,0(puv1AA)
		lfs		fv1aa,4(puv1AA)
		fmuls		fu1aa,fu1aa,fduscale
		fmuls		fv1aa,fv1aa,fdvscale
		fmuls		fu1aa,fu1aa,fw1aa
		fmuls		fv1aa,fv1aa,fw1aa
		...
		li		itemp0,3
		addis		itemp0,itemp0,0x200f
		stwu		itemp0,4(pVI)

		bf		y1eqy0FLAG,detoct0
		bl		drawv0v1
		stfs		f0pt5aa,(-(1*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		stfs		f0pt5aa,(-(2*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		stfs		f0pt5aa,(-(3*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		stfs		f0pt5aa,(-(4*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
...
/*		stfs	ftmp0aa,(-(4*outvtxtexaa)+4+outvtxtexaa.y)(pVI)	*/
/*		stfs	ftmp1aa,(-(2*outvtxtexaa)+4+outvtxtexaa.y)(pVI)	*/
/*		b		detoct3	*/
/*oct_www_ccw:	*/
		fadds		ftmp0aa,fy0aa,f1pt0aa
		fadds		ftmp1aa,fy1aa,f1pt0aa
		stfs		ftmp0aa,(-(3*outvtxtexaa)+4+outvtxtexaa.y)(pVI)
		stfs		ftmp1aa,(-(1*outvtxtexaa)+4+outvtxtexaa.y)(pVI)
		b		detoct5
/*
 * y1 = y0, x1 < x0
 */
...
/*		stfs	ftmp0aa,(-(4*outvtxtexaa)+4+outvtxtexaa.x)(pVI)	*/
/*		stfs	ftmp1aa,(-(2*outvtxtexaa)+4+outvtxtexaa.x)(pVI)	*/
/*		b		detoct5	*/
/*oct_nnn_ccw:	*/
		fsubs		ftmp0aa,fx0aa,f1pt0aa
		fsubs		ftmp1aa,fx1aa,f1pt0aa
		stfs		ftmp0aa,(-(3*outvtxtexaa)+4+outvtxtexaa.x)(pVI)
		stfs		ftmp1aa,(-(1*outvtxtexaa)+4+outvtxtexaa.x)(pVI)
		b		detoct3
/*
 * x1 == x0, y1 < y0
 */
...
/*		fsubs	ftmp1aa,fx1aa,f1pt0aa	*/
/*		fsubs	ftmp0aa,fx0aa,f1pt0aa	*/
/*		stfs	ftmp1aa,(-(4*outvtxtexaa)+4+outvtxtexaa.x)(pVI)	*/
/*		stfs	ftmp0aa,(-(2*outvtxtexaa)+4+outvtxtexaa.x)(pVI)	*/
/*		stfs	f0pt0aa,(-(4*outvtxtexaa)+4+outvtxtexaa.a)(pVI)	*/
/*		stfs	f0pt0aa,(-(2*outvtxtexaa)+4+outvtxtexaa.a)(pVI)	*/
/*		b		detoct3	*/
/*oct_nne_ccw:	*/
		fadds		ftmp1aa,fx1aa,f1pt0aa
		fadds		ftmp0aa,fx0aa,f1pt0aa
		stfs		ftmp1aa,(-(3*outvtxtexaa)+4+outvtxtexaa.x)(pVI)
		stfs		ftmp0aa,(-(1*outvtxtexaa)+4+outvtxtexaa.x)(pVI)
		stfs		f0pt0aa,(-(3*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		stfs		f0pt0aa,(-(1*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		b		detoct5
/*
 * y1 < y0, x1 > x0, dy <= dx
 */
...
/*		fadds	ftmp1aa,fy1aa,f1pt0aa	*/
/*		fadds	ftmp0aa,fy0aa,f1pt0aa	*/
/*		stfs	ftmp1aa,(-(4*outvtxtexaa)+4+outvtxtexaa.y)(pVI)	*/
/*		stfs	ftmp0aa,(-(2*outvtxtexaa)+4+outvtxtexaa.y)(pVI)	*/
/*		stfs	f0pt0aa,(-(4*outvtxtexaa)+4+outvtxtexaa.a)(pVI)	*/
/*		stfs	f0pt0aa,(-(2*outvtxtexaa)+4+outvtxtexaa.a)(pVI)	*/
/*		b		detoct5	*/
/*oct_wnw_ccw:	*/
		fsubs		ftmp1aa,fy1aa,f1pt0aa
		fsubs		ftmp0aa,fy0aa,f1pt0aa
		stfs		ftmp1aa,(-(3*outvtxtexaa)+4+outvtxtexaa.y)(pVI)
		stfs		ftmp0aa,(-(1*outvtxtexaa)+4+outvtxtexaa.y)(pVI)
		stfs		f0pt0aa,(-(3*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		stfs		f0pt0aa,(-(1*outvtxtexaa)+4+outvtxtexaa.a)(pVI)
		b		detoct3
/*
