...
/*
 *	Directional with specular for untextured surfaces
 *
...
/*	normalize dot products					*/
		...
		lfs		ds_red,DirSpec.sr(plightlist)
		lfs		ds_green,DirSpec.sg(plightlist)
		lfs		ds_blue,DirSpec.sb(plightlist)

		fmuls		ds_out0,ds_out0,ds_dot00
		fmuls		ds_out1,ds_out1,ds_dot10

		fmadds		fracc0,ds_out0,ds_red,fracc0
		fmadds		fracc1,ds_out1,ds_red,fracc1
		fmadds		fgacc0,ds_out0,ds_green,fgacc0
		fmadds		fgacc1,ds_out1,ds_green,fgacc1
		fmadds		fbacc0,ds_out0,ds_blue,fbacc0
		fmadds		fbacc1,ds_out1,ds_blue,fbacc1

		fsubs		ds_red,fracc0,spec_const1
		fsubs		ds_green,fgacc0,spec_const1
		fsubs		ds_blue,fbacc0,spec_const1
		fsel		fracc0,ds_red,spec_const1,fracc0
		fsel		fgacc0,ds_green,spec_const1,fgacc0
		fsel		fbacc0,ds_blue,spec_const1,fbacc0
		fsubs		ds_red,fracc1,spec_const1
		fsubs		ds_green,fgacc1,spec_const1
		fsubs		ds_blue,fbacc1,spec_const1
		fsel		fracc1,ds_red,spec_const1,fracc1
		fsel		fgacc1,ds_green,spec_const1,fgacc1
		fsel		fbacc1,ds_blue,spec_const1,fbacc1
		b		skipskip
.skip:
		fsel		ds_dot0,ds_dot0,ds_dot0,ds_0pt0
		fsel		ds_dot1,ds_dot1,ds_dot1,ds_0pt0
