...
#include <audio/audio.h>        /* GetAudioTime() */
...
/****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name DefineClass
...
/****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name ValidateObject
 |||	Validates an object.
 |||
 |||	  Synopsis
 |||
...
/****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name CreateObject
 ...
 |||
 |||	    Class
 |||	        A pointer to the COBClass data structure for
 |||	        the class (currently available:
 |||	        &SequenceClass and &CollectionClass as
 |||	        defined in <audio/juggler.h>).
 |||
 |||	  Return Value
 |||
...
DBUG(( "\nCreateObject(0x%x)\n", Class ));
	...
	cob = (COBObject *) AllocMem(Class->DataSize, MEMTYPE_FILL); /* JG_MA%00001 */
	if (cob  ==  NULL)
	{
...
/****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name DestroyObject
 |||	Destroys an object.
 |||
 |||	  Synopsis
 |||
...
DBUG(("DestroyObject: free object.\n"));
	FreeMem(Object, Class->DataSize);   /* JG_MF%00001 */
...
/****************************************************************************/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Classes -name JuggleeClass
 |||	Root juggler class.
 |||
 |||	  Description
 |||
...
COBClass JuggleeClass;
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Classes -name SequenceClass
...
COBClass SequenceClass;
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Classes -name CollectionClass
...
static int32 AllocSequence ( Sequence *Self, int32 NumElements )
{
	...
	Self->seq_Events = (char *)AllocMem( (NumElements * Self->seq_EventSize ), MEMTYPE_FILL | MEMTYPE_TRACKSIZE);
	if(Self->seq_Events == NULL)
	{
...
/* Allocate PlaceHolder */
	plch = (PlaceHolder *) AllocMem( sizeof(PlaceHolder), MEMTYPE_FILL ); /* JG_MA%00002 */
	if (plch == NULL) return ML_ERR_NOMEM;
...
static int32 RemoveNthFromCollection( Collection *Self, int32 N)
{
	...
	RemNode( nd );
	FreeMem( nd, sizeof(PlaceHolder));  /* JG_MF%00002 */
	Self->jglr_Many--;
	return 0;
}
...
/****************************************************************************/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name InitJuggler
...
/* Define Jugglee Classe. */
	...
	JuggleeClass.Init = (int32 (*)()) InitJugglee;
	JuggleeClass.Term = (int32 (*)()) TermJugglee;
	JuggleeClass.Print = (int32 (*)()) PrintJugglee;
	JuggleeClass.Start = (int32 (*)()) StartJugglee;
	JuggleeClass.Stop = (int32 (*)()) StopJugglee;
	JuggleeClass.Abort = (int32 (*)()) AbortJugglee;
	JuggleeClass.Rewind = (int32 (*)()) RewindJugglee;
	JuggleeClass.SetInfo = (int32 (*)()) SetJuggleeInfo;
	JuggleeClass.GetInfo = (int32 (*)()) GetJuggleeInfo;

/* Define Sequence Classe. */
	Result = DefineClass ( &SequenceClass , &JuggleeClass, sizeof(Sequence));
	CHECKRESULT( "DefineClass" );
	SequenceClass.Init = (int32 (*)()) InitSequence;
	SequenceClass.Print = (int32 (*)()) PrintSequence;
	SequenceClass.Start = (int32 (*)()) StartSequence;
	SequenceClass.Stop = (int32 (*)()) StopSequence;
	SequenceClass.Abort = (int32 (*)()) AbortSequence;
	SequenceClass.Rewind = (int32 (*)()) RewindSequence;
	SequenceClass.Bump = (int32 (*)()) BumpSequence;
	SequenceClass.Alloc = (int32 (*)()) AllocSequence;
	SequenceClass.Free = (int32 (*)()) FreeSequence;
	SequenceClass.SetInfo = (int32 (*)()) SetSequenceInfo;
	SequenceClass.GetInfo = (int32 (*)()) GetSequenceInfo;

/* Define Collection Classe. */
	Result = DefineClass ( &CollectionClass , &JuggleeClass, sizeof(Collection));
	CHECKRESULT( "DefineClass" );
	CollectionClass.Init = (int32 (*)()) InitCollection;
	CollectionClass.Print = (int32 (*)()) PrintCollection;
	CollectionClass.Start = (int32 (*)()) StartCollection;
	CollectionClass.Stop = (int32 (*)()) StopCollection;
	CollectionClass.Add = (int32 (*)()) AddCollection;
	CollectionClass.Abort = (int32 (*)()) AbortCollection;
	CollectionClass.GetNthFrom = (int32 (*)()) GetNthFromCollection;
	CollectionClass.RemoveNthFrom = (int32 (*)()) RemoveNthFromCollection;
	CollectionClass.Done = (int32 (*)()) DoneCollection;
...
/****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name TermJuggler
...
*****************************************************************************/
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name BumpJuggler
 ...
 |||
 |||	    CurrentTime
 |||	        Value indicating the current time that the
 |||	        procedure is called.
 |||
 |||	    NextTime
 |||	        Pointer to a value where this procedure
 |||	        writes the time that it should be called again.
 |||
 |||	    CurrentSignals
 |||	        The current signal mask.
 |||
 |||	    NextSignals
 |||	        Pointer to a signal mask where this
 |||	        procedure writes the signal bits for which
 |||	        the task should wait before making this call again.
 |||
 |||	  Return Value
 |||
 |||	    This procedure returns 0 if successful or an error code (a negative value)
...
/* -------------------- cobj macro docs */
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name PrintObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name SetObjectInfo
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name GetObjectInfo
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name StartObject
 ...
 |||
 |||	    time
 |||	        A value indicating the time in audio clock
 ...
 |||
 |||	    par
 |||	        A pointer to the CObject data structure that
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name StopObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name AbortObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name AllocObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name FreeObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name GetNthFromObject
 ...
 **/
 ...
 /**
 |||	AUTODOC -public -class libmusic -group Juggler_Functions -name RemoveNthFromObject
