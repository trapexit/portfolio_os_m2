...
dccopts		=	 ¶
				...
				-Xansi				# (Self-evident.  Won't allow // comments!)¶
				-Xunsigned-char		# Treat the char type as unsigned.¶
				{DEBUG_OPTIONS} ¶
				-Xforce-prototypes	# Compiler will complain about functions without 'em¶
				-Xlint=0x50			# All warnings except unused variable/function.  Add more bits (from 0xFE) for fewer warnings.¶
...
.c.o Ä .c fight.make
	...
	if {USE_PPCAS}
		Set Echo 1
		dcc {depDir}{default}.c {defines} {dccopts} -I{INCLUDEDIR} -I::helloworld -Xdebug-mode=6 -S -o "{TempFolder}"{default}.s
