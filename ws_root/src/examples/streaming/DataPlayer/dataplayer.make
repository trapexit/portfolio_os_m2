...
"{ObjectDir}".c.o	Ä	:joypad.h
"{ObjectDir}".c.o	Ä	:initstream.h
...
"{ObjectDir}".c.o	Ä	"{3DOIncludes}"streaming:saudiosubscriber.h
"{ObjectDir}".c.o	Ä	"{3DOIncludes}"streaming:controlsubscriber.h
"{ObjectDir}".c.o	Ä	"{3DOIncludes}"streaming:datasubscriber.h
