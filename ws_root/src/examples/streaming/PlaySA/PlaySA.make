...
#	make Depends -f PlaySA.make  ³³ "{worksheet}" > temp.makeout; temp.makeout ·· "{worksheet}"; delete -i temp.makeout
#
#####################################
...
"{AppDir}"{App}	Ä	{App}.make {OBJECTS} {LIBDEPENDS}
	...
	{LINK} {Link3DOOptions} -o {Targ}		¶
		...
		{LIBS}								¶
		{LOptions}							¶
		#-m2 > {AppDir}{App}.map	# Writing a map file crashes!
...
"{ObjectDir}"PlaySA.c.o	Ä	:playssndstream.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:saudiosubscriber.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:datastream.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:msgutils.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:mempool.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:dsstreamdefs.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:dserror.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:sacontrolmsgs.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:preparestream.h
"{ObjectDir}"PlaySA.c.o	Ä	"{3DOIncludes}"Streaming:datastreamlib.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	:playssndstream.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:datastream.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:msgutils.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:mempool.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:dsstreamdefs.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:dserror.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:datastreamlib.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:sacontrolmsgs.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:saudiosubscriber.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:satemplatedefs.h
"{ObjectDir}"PlaySSNDStream.c.o	Ä	"{3DOIncludes}"Streaming:preparestream.h
