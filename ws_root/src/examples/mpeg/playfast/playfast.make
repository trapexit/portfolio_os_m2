...
DLLS			=	{STD_MODULE}			¶
					"{VectorDir}graphics" "{VectorDir}gstate"
...
"{ObjectDir}"playfast.c.o	Ä	"{3DOIncludes}"Misc:event.h
"{ObjectDir}"playfast.c.o	Ä	"{3DOIncludes}"Device:mpegvideo.h
