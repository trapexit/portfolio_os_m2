######################
# @(#) folioexamples.make 96/09/25 1.13
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

OBJECTS =	:objects:autosizeview.c.o ¶
		:objects:manyview.c.o :objects:listprojectors.c.o ¶
		:objects:listviewtypes.c.o :objects:basicview.c.o ¶
		:objects:dbuf.c.o


FINALDIRECTORY = "{3doremote}"Examples:Graphics:graphicsfolio:

# Choose one of the following:
DEBUG_OPTIONS = -g # For best source-level debugging
# DEBUG_OPTIONS = -XO -Xunroll=1 -Xtest-at-bottom -Xinline=5

app_name = folioexamples
