######################
# @(#) testblit.make 96/08/29 1.2
######################
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

FINALDIRECTORY = "{3doremote}"Examples:Graphics:blitter:testblit:
...
LIBS		= -lblitter_utils -l3do_scaf -lsubscriber -lds -ldsutils -lEZFlixDecoder -lmusic  ¶
				-lclt -lspmath ¶
				-leventbroker -lc
