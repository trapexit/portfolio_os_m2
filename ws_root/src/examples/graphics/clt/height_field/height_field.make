######################
# @(#) height_field.make 96/04/18 1.7
######################
...
FINALDIRECTORY = "{3doremote}"Examples:Graphics:CLT:height_field:
...
appname		= height_field

LIBS		= -lsubscriber -lds -ldsutils -lEZFlixDecoder -lmusic -lframe_utils -lframework -lbsdf ¶
				-lpbsdf -lframework -lpipeline -lframe_utils ¶
				-lbsdf -lpbsdf -lclt -lspmath ¶
				-leventbroker -lc
