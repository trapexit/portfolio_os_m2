######################
# @(#) scrolling.make 96/08/20 1.5
######################
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

FINALDIRECTORY = "{3doremote}"Examples:Graphics:CLT:scrolling:


OBJECTS = ¶
		:objects:AsyncReadFile.c.o ¶
		:objects:clip3.c.o ¶
