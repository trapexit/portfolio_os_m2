######################
# @(#) kernel.make 96/09/06 1.15
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

Objects		=	:objects:defaultport.c.o :objects:fasttiming.c.o		¶
			:objects:UserExceptions.c.o	:objects:memdebug.c.o		¶
			:objects:argpassing.c.o	:objects:metronome.c.o		¶
				:objects:msgpassing.c.o		¶
				:objects:signals.c.o		¶
				:objects:timerread.c.o		¶
				:objects:timersleep.c.o

FINALDIRECTORY = "{3doremote}"Examples:kernel:
