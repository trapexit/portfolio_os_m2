######################
# @(#) Beep.make 96/08/20 1.5
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

Objects		=	:objects:tb_envelope.c.o					¶
				:objects:tb_playsamp.c.o				¶
				:objects:tb_spool.c.o		

FINALDIRECTORY = "{3doremote}"Examples:Audio:beep:
...
MODULES		= "{MODULEDIR}"audio "{MODULEDIR}"font "{MODULEDIR}"beep ¶
