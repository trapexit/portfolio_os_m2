######################
# @(#) Sound3D.make 96/08/20 1.5
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

Objects		=	:objects:ta_bee3d.c.o					¶
				:objects:ta_leslie.c.o				¶
				:objects:ta_sound3d.c.o			¶
				:objects:ta_steer3d.c.o			
				
FINALDIRECTORY = "{3doremote}"Examples:Audio:Sound3d:
