######################
# @(#) ez3dsound.make 96/08/21 1.3
######################
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

FINALDIRECTORY = "{3doremote}"Examples:Audio:ez3dsound:


OBJECTS = ¶
		:objects:ez3dsound.c.o ¶
		:objects:ez3dsound_app.c.o
...
BOOTDIR	= "{VECTORDIR}"
### CASE 2.0:
#MODULEDIR	= TheBreedingPit:3DO:3DO_OS:M2_3.0b:Remote:System.m2:Modules:
#BOOTDIR	= TheBreedingPit:3DO:3DO_OS:M2_3.0b:Remote:System.m2:Boot:
### } END SWITCH
