######################
# @(#) ezsound.make 96/08/20 1.2
######################
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

FINALDIRECTORY = "{3doremote}"Examples:Audio:ezsound:


OBJECTS = ¶
		:objects:ezsound.c.o ¶
		:objects:ezsound_app.c.o
