...
/******************************************************************************
**
**  @(#) CoalRiver.c 96/08/27 1.8
**  $Id: CoalRiver.c,v 1.12 1995/01/16 19:48:35 vertex Exp $
**
******************************************************************************/

/**
|||	!!! disabled AUTODOC -public -class examples -group Audio -name CoalRiver
|||	Plays a MIDI file using Juggler and Score toolbox.
|||
|||	  Format
|||
|||	    CoalRiver
...
|||	    libmusic.a and audio folio, and demonstrates special MIDI interpreter
|||	    functions.
|||
...
|||	    titles use fewer or smaller compressed samples.
|||
|||	  Associated Files
|||
|||	    CoalRiver.c
...
|||
|||	    CoalRiver.imag
|||	        Background image which contains program
|||	        instructions.
|||
|||	    CoalRiver.mf
...
#include <lib3DO/utils3do.h>    /* !!! this doesn't work */
#include "displayutils.h"       /* !!! where is this? */
/* !!! #include "debug.h" */
...
void pmfPrintInstructions(void)
{
	printf("\nCoalRiver version %s\n", VERSION );
