######################
# @(#) Misc.make 96/08/20 1.5
######################
#   This Makefile modified from a generic CreateM2Make makefile for use with
#   SSJJ example code.

Objects		=	:objects:capture_audio.c.o			¶
				:objects:minmax_audio.c.o			¶
				:objects:playsample.c.o				¶
				:objects:simple_envelope.c.o		¶
				:objects:ta_attach.c.o				¶
				:objects:ta_customdelay.c.o			¶
				:objects:ta_envelope.c.o			¶
				:objects:ta_pitchnotes.c.o			¶
				:objects:ta_sweeps.c.o				¶
				:objects:ta_timer.c.o				¶
				:objects:ta_tuning.c.o				¶
				:objects:tone.c.o

FINALDIRECTORY = "{3doremote}"Examples:Audio:Misc:
