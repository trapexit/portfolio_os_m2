...
/*dwarf C++ extentions for Diab Data */
    AT_mangled_name		= (0x0500|FORM_STRING),
	AT_glob_cpp			= (0x0300|FORM_BLOCK2)
};
...
#define LOP_LO_USER	0x80  /* implementation-defined range start */
#define LOP_HI_USER	0xff  /* implementation-defined range end */
