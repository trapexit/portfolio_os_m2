/*
 * File: @(#) clttxdblend.h 95/12/15 1.23
 * Copyright: The 3DO Company, June 28, 1995
 */

#ifndef _GRAPHICS_CLT_CLTTXDBLEND_H
#define _GRAPHICS_CLT_CLTTXDBLEND_H
...
#define		DBL_MASeelctSrcalpha			CLT_Const(DBAMULTCNTL, AMULTCOEFSELECT, SRCALPHA)
...
#endif /*_GRAPHICS_CLT_CLTTXDBLEND_H */
