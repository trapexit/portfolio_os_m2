...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclUtil.c,v 1.60 91/10/17 15:49:56 ouster Exp $ SPRITE (Berkeley)";
#endif
 ...
 * and used by Tcl_ConvertElement.
 */
				 ...
				 * Tcl_ConvertElement. */
{
     ...
     *
     * 1. They produces a proper list, one that will yield back the
    ...
    if ((nestingLevel != 0) || (flags & CANT_USE_BRACES)) {
	flags = CANT_USE_BRACES;
    }
    *flagPtr = flags;
