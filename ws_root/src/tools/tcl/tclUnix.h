 ...
 *
 * $Header: /user6/ouster/tcl/RCS/tclUnix.h,v 1.21 91/11/07 09:41:54 ouster Exp $ SPRITE (Berkeley)
 */
 ...
 * TCL_PID_T -			1 means that <sys/types> defines types
...
#ifdef NOTDEF
extern int	open	_ANSI_ARGS_((CONST char *path, int flags, int mode));
#endif
