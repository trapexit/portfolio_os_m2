...
#ifndef lint
static char rcsid[] = "$Header: /sprite/src/lib/tcl/compat/RCS/strerror.c,v 1.1 91/09/19 16:22:10 ouster Exp $ SPRITE (Berkeley)";
#endif /* not lint */
...
#else
#if EWOULDBLOCK != EDEADLK
	case EDEADLK: return "resource deadlock avoided";
#endif /* EWOULDBLOCK != EDEADLK */
#endif /* EWOULDBLOCK */
#endif /* EDEADLK */
#ifdef EDEADLOCK
