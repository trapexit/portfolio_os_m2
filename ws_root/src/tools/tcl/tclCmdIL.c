...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclCmdIL.c,v 1.82 91/10/31 16:41:50 ouster Exp $ SPRITE (Berkeley)";
#endif
...
static int		SortCompareProc _ANSI_ARGS_((CONST char *first,
			    CONST char *second));

/*
 *----------------------------------------------------------------------
    ...
    char **argv;			/* Argument strings. */
{
    ...
    qsort((char *) listArgv, listArgc, sizeof (char *), (void *)SortCompareProc);
...
SortCompareProc(first, second)
    CONST char *first, *second;		/* Elements to be compared. */
{
