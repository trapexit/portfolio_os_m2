/*  :ts=8 bk=0
 *
 * db_ntsc.c:	View type database, NTSC interlaced
 *
 * @(#) db_ntsc.c 96/06/14 1.2
 *
...
BDAVTI	bdavtis_ntsc[] = {
 {
	PROJTYPE_NTSC | VIEWTYPE_INVALID,
	0,
	0, 0,
	0, 0,
	0, NULL,
	...
	PROJTYPE_NTSC | VIEWTYPE_16_LACE,
	...
	PROJTYPE_NTSC | VIEWTYPE_32_LACE,
	VTIF_BMTYPES_ALLOWED | VTIF_ABLE_AVG_H,
	320, 480,
	2, 1,
	N32TYPES, vt32types,
	...
	PROJTYPE_NTSC | VIEWTYPE_16_640_LACE,
	...
	PROJTYPE_NTSC | VIEWTYPE_32_640_LACE,
	VTIF_BMTYPES_ALLOWED,
	640, 480,
	1, 1,
	N32TYPES, vt32types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_16_LACE,
	VTIF_BMTYPES_ALLOWED,
	320, 480,
	2, 1,
	N16TYPES, vt16types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_32_LACE,
	VTIF_BMTYPES_ALLOWED,
	320, 480,
	2, 1,
	N32TYPES, vt32types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_16_640,
	VTIF_BMTYPES_ALLOWED,
	640, 240,
	1, 2,
	N16TYPES, vt16types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_16_640_LACE,
	VTIF_BMTYPES_ALLOWED,
	640, 480,
	1, 1,
	N16TYPES, vt16types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_32_640,
	VTIF_BMTYPES_ALLOWED,
	640, 240,
	1, 2,
	N32TYPES, vt32types,
	...
	PROJTYPE_NTSC | VIEWTYPE_YUV_32_640_LACE,
	VTIF_BMTYPES_ALLOWED,
	640, 480,
	1, 1,
	N32TYPES, vt32types,
...
#define NVTYPES	(sizeof (bdavtis_ntsc) / sizeof (BDAVTI))
...
struct ViewTypeInfo	*vti;
{
	...
	if (vti) {
		...
		bv = (BDAVTI *) vti;
		if (bv - bdavtis_ntsc < NVTYPES - 1)
			return ((ViewTypeInfo *) (bv + 1));
		else
			return (NULL);
	} else
		return (&bdavtis_ntsc->bv);
}
