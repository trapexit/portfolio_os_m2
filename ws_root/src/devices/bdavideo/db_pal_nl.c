/*  :ts=8 bk=0
 *
 * db_pal_nl.c:	View type database, PAL non-interlaced
 *
 * @(#) db_pal_nl.c 96/06/14 1.1
 *
...
BDAVTI	bdavtis_pal_nl[] = {
 {
	PROJTYPE_PAL_NOLACE | VIEWTYPE_INVALID,
	0,
	0, 0,
	0, 0,
	0, NULL,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_16,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_32,
	VTIF_BMTYPES_ALLOWED | VTIF_ABLE_AVG_H,
	384, 288,
	1, 1,
	N32TYPES, vt32types,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_16_640,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_32_640,
	VTIF_BMTYPES_ALLOWED,
	768, 288,
	1, 2,
	N32TYPES, vt32types,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_YUV_16,
	VTIF_BMTYPES_ALLOWED,
	384, 288,
	1, 1,
	N16TYPES, vt16types,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_YUV_32,
	VTIF_BMTYPES_ALLOWED,
	384, 288,
	1, 1,
	N32TYPES, vt32types,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_YUV_16_640,
	VTIF_BMTYPES_ALLOWED,
	768, 288,
	1, 2,
	N16TYPES, vt16types,
	...
	PROJTYPE_PAL_NOLACE | VIEWTYPE_YUV_32_640,
	VTIF_BMTYPES_ALLOWED,
	768, 288,
	1, 2,
	N32TYPES, vt32types,
...
#define NVTYPES	(sizeof (bdavtis_pal_nl) / sizeof (BDAVTI))


struct ViewTypeInfo *
nextvti_pal_nl (p, vti)
struct Projector	*p;
struct ViewTypeInfo	*vti;
{
	...
	if (vti) {
		...
		bv = (BDAVTI *) vti;
		if (bv - bdavtis_pal_nl < NVTYPES - 1)
			return ((ViewTypeInfo *) (bv + 1));
		else
			return (NULL);
	} else
		return (&bdavtis_pal_nl->bv);
}
