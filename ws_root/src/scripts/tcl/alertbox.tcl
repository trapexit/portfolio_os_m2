################################################
#DOC: alertbox template from xf 2.2
################################################
...
#
# $Header: /home/rhett/hayes/grafix.soft/RCS/alertbox.tcl,v 1.1 1994/05/24 20:15:25 mark Exp $
...
proc AlertBox {{alertBoxMessage {Alert message}} {alertBoxCommand ""} {alertBoxGeometry 350x150} {alertBoxTitle "Message"} args} {# xf ignore me 5
##########
# Procedure: AlertBox
...
# global alertBox(after) - destroy puts stderr $objalert box after n seconds
