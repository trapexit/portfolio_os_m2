...
/* Common tags used when creating any type of item */
enum item_tags
{
    TAG_ITEM_NAME = 1,          /* item's name              */
    TAG_ITEM_PRI,               /* item's priority (0..255) */
    TAG_ITEM_VERSION,           /* item's version (0..255)  */
    TAG_ITEM_REVISION,          /* item's revision (0..255) */
...
Item  OpenItemAsTask(Item foundItem, void *args, Item task);
Err   CloseItemAsTask(Item i, Item task);
Err   TransferItems(Item recipientTask);
