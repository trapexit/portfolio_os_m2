#ifndef __AUDIO_SOUNDSPOOLER_H
#define __AUDIO_SOUNDSPOOLER_H


/****************************************************************************
**
**  @(#) soundspooler.h 96/02/23 1.11
...
/* Start class messages */
    ...
    /* Initial Start - ssplStartSpoolerTags() sends this message for the
...
#define SSPL_STATUS_F_STARTED       0x02    /* Indicates that spooler
                                               ...
                                               ssplStartSpoolerTags(). Cleared by
                                               ssplStopSpooler() (and
                                               ssplAbort()). */
