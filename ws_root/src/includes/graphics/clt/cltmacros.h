...
#define __GRAPHICS_CLT_CLTMACROS_H


/******************************************************************************
**
**  @(#) cltmacros.h 96/07/31 1.21
**
...
#define RA_TXTLDWIDTH			0x642C
#	define FV_TXTLDWIDTH_DSTROWBITS_MASK	PPCMASK(0xFFFF, 15)
#	define FV_TXTLDWIDTH_DSTROWBITS_SHIFT	PPCSHIFT(15)
#	define FV_TXTLDWIDTH_SRCROWBITS_MASK	PPCMASK(0xFFFF, 31)
#	define FV_TXTLDWIDTH_SRCROWBITS_SHIFT	PPCSHIFT(31)
...
#	define FV_DBINTCNTL_ALUSTAT_MASK		PPCMASK(0x1FF,27)
#	define FV_DBINTCNTL_ALUSTAT_SHIFT		PPCSHIFT(27)
#	define FV_DBINTCNTL_ZFUNCSTAT_MASK		PPCMASK(7,30)
#	define FV_DBINTCNTL_ZFUNCSTAT_SHIFT		PPCSHIFT(30)
...
#define	CLA_ESCNTL(perspective, duscan, dspoff) \
    (CLT_Bits(ESCNTL, PERSPECTIVEOFF, perspective) | \
     CLT_Bits(ESCNTL, DUSCAN, duscan) | \
     CLT_Bits(ESCNTL, DSPOFF, dspoff))

#define CLT_ESCNTL(pp, perspective, duscan, dspoff) \
	CLT_WriteRegister((*pp), ESCNTL, CLA_ESCNTL(perspective, duscan, dspoff))


/* Texture mapper */

#define CLA_TXTLDCNTL(compressed, loadmode, srcbitoff)\
					  (CLT_Bits(TXTLDCNTL, COMPRESSED, compressed) | \
					   CLT_Bits(TXTLDCNTL, LOADMODE, loadmode) | \
					   CLT_Bits(TXTLDCNTL, SRCBITOFF, srcbitoff))

#define CLT_TXTLDCNTL(pp, compressed, loadmode, srcbitoff)\
	CLT_WriteRegister((*pp), TXTLDCNTL,  CLA_TXTLDCNTL(compressed, loadmode, srcbitoff))
...
#define CLA_TXTPIPCNTL(pipssbselect, pipalphaselect, pipcolorselect, pipindexoffset) \
...
#define CLT_TXTPIPCNTL(pp, pipssbselect, pipalphaselect, pipcolorselect, pipindexoffset) \
	CLT_WriteRegister((*pp), TXTPIPCNTL,  \
					  CLA_TXTPIPCNTL(pipssbselect, pipalphaselect, pipcolorselect, pipindexoffset))

#define CLT_TxtControl(pp, a, p, b) \
...
#define CLT_TxtLoad4LOD(pp, b0, b1, b2, b3) \
...
#define CLT_TXTLODBASE0(pp, x)				CLT_WriteRegister((*pp), TXTLODBASE0, x)
#define CLT_TXTLODBASE1(pp, x)				CLT_WriteRegister((*pp), TXTLODBASE1, x)
#define CLT_TXTLODBASE2(pp, x)				CLT_WriteRegister((*pp), TXTLODBASE2, x)
#define CLT_TXTLODBASE3(pp, x)				CLT_WriteRegister((*pp), TXTLODBASE3, x)
...
#define CLA_TXTUVMAX(umax, vmax) \
							(CLT_Bits(TXTUVMAX, UMAX, umax) | \
							 CLT_Bits(TXTUVMAX, VMAX, vmax))

#define CLT_TXTUVMAX(pp, umax, vmax)			CLT_WriteRegister((*pp), TXTUVMAX, \
									  CLA_TXTUVMAX(umax, vmax))

#define CLA_TXTLDWIDTH(dstrowbits, srcrowbits) \
							(CLT_Bits(TXTLDWIDTH, DSTROWBITS, dstrowbits) | \
							 CLT_Bits(TXTLDWIDTH, SRCROWBITS, srcrowbits))

#define CLT_TXTLDWIDTH(pp, dstrowbits, srcrowbits)	CLT_WriteRegister((*pp), TXTLDWIDTH, \
									  CLA_TXTLDWIDTH(dstrowbits, srcrowbits))

#define CLA_TXTUVMASK(umask, vmask) \
						  	(CLT_Bits(TXTUVMASK, UMASK, umask) | \
							 CLT_Bits(TXTUVMASK, VMASK, vmask))
#define CLT_TXTUVMASK(pp, umask, vmask)		CLT_WriteRegister((*pp), TXTUVMASK, \
								  CLA_TXTUVMASK(umask, vmask))

#define CLA_TXTSRCTYPE01(cdepth0, adepth0, istrans0, hasssb0, hascolor0, hasalpha0, isliteral0, \
						cdepth1, adepth1, istrans1, hasssb1, hascolor1, hasalpha1, isliteral1) \
					  (CLT_Bits(TXTSRCTYPE01, CDEPTH0, cdepth0) |\
					   CLT_Bits(TXTSRCTYPE01, ADEPTH0, adepth0) |\
					   CLT_Bits(TXTSRCTYPE01, ISTRANS0, istrans0) |\
					   CLT_Bits(TXTSRCTYPE01, HASSSB0, hasssb0) |\
					   CLT_Bits(TXTSRCTYPE01, HASCOLOR0, hascolor0) |\
					   CLT_Bits(TXTSRCTYPE01, HASALPHA0, hasalpha0) |\
					   CLT_Bits(TXTSRCTYPE01, ISLITERAL0, isliteral0) |\
					   CLT_Bits(TXTSRCTYPE01, CDEPTH1, cdepth1) |\
					   CLT_Bits(TXTSRCTYPE01, ADEPTH1, adepth1) |\
					   CLT_Bits(TXTSRCTYPE01, ISTRANS1, istrans1) |\
					   CLT_Bits(TXTSRCTYPE01, HASSSB1, hasssb1) |\
					   CLT_Bits(TXTSRCTYPE01, HASCOLOR1, hascolor1) |\
					   CLT_Bits(TXTSRCTYPE01, HASALPHA1, hasalpha1) |\
					   CLT_Bits(TXTSRCTYPE01, ISLITERAL1, isliteral1))

#define CLT_TXTSRCTYPE01(pp, cdepth0, adepth0, istrans0, hasssb0, hascolor0, hasalpha0, isliteral0, \
						cdepth1, adepth1, istrans1, hasssb1, hascolor1, hasalpha1, isliteral1) \
	CLT_WriteRegister((*pp), TXTSRCTYPE01, \
					  CLA_TXTSRCTYPE01(cdepth0, adepth0, istrans0, hasssb0, hascolor0, \
									  hasalpha0, isliteral0, \
						cdepth1, adepth1, istrans1, hasssb1, hascolor1, \
									  hasalpha1, isliteral1))

#define CLA_TXTSRCTYPE23(cdepth2, adepth2, istrans2, hasssb2, hascolor2, hasalpha2, isliteral2, \
						cdepth3, adepth3, istrans3, hasssb3, hascolor3, hasalpha3, isliteral3) \
					  (CLT_Bits(TXTSRCTYPE23, CDEPTH2, cdepth2) |\
					   CLT_Bits(TXTSRCTYPE23, ADEPTH2, adepth2) |\
					   CLT_Bits(TXTSRCTYPE23, ISTRANS2, istrans2) |\
					   CLT_Bits(TXTSRCTYPE23, HASSSB2, hasssb2) |\
					   CLT_Bits(TXTSRCTYPE23, HASCOLOR2, hascolor2) |\
					   CLT_Bits(TXTSRCTYPE23, HASALPHA2, hasalpha2) |\
					   CLT_Bits(TXTSRCTYPE23, ISLITERAL2, isliteral2) |\
					   CLT_Bits(TXTSRCTYPE23, CDEPTH3, cdepth3) |\
					   CLT_Bits(TXTSRCTYPE23, ADEPTH3, adepth3) |\
					   CLT_Bits(TXTSRCTYPE23, ISTRANS3, istrans3) |\
					   CLT_Bits(TXTSRCTYPE23, HASSSB3, hasssb3) |\
					   CLT_Bits(TXTSRCTYPE23, HASCOLOR3, hascolor3) |\
					   CLT_Bits(TXTSRCTYPE23, HASALPHA3, hasalpha3) |\
					   CLT_Bits(TXTSRCTYPE23, ISLITERAL3, isliteral3))

#define CLT_TXTSRCTYPE23(pp, cdepth2, adepth2, istrans2, hasssb2, hascolor2, hasalpha2, isliteral2, \
						cdepth3, adepth3, istrans3, hasssb3, hascolor3, hasalpha3, isliteral3) \
	CLT_WriteRegister((*pp), TXTSRCTYPE23, \
					  CLA_TXTSRCTYPE23(cdepth2, adepth2, istrans2, hasssb2, hascolor2, \
...
#define CLT_DbDitherMatrix(pp, dmA, dmB)	CLT_Write2Registers((*pp), DBDITHERMATRIXA, dmA, dmB)
...
#define CLT_VertexUvW(pp, x, y, u, v, w) \
  ...
  *(float*)(*pp)++ = (float)u;	\
  *(float*)(*pp)++ = (float)v; }
#define CLT_VertexUv(pp, x, y, u, v) \
  { *(float*)(*pp)++ = (float)x;	\
  *(float*)(*pp)++ = (float)y;	\
  *(float*)(*pp)++ = (float)u;	\
  *(float*)(*pp)++ = (float)v; }
...
#define CLT_Nop(pp) \
	{ *(uint32*)(*pp)++ = (uint32)CLT_ClearRegistersHeader(TXTCONST0,1); \
	*(uint32*)(*pp)++ = 0; }




/* Obsolete, but left in for backward compatibility: */

#define CLT_TxControl		CLT_TxtControl
#define CLT_TxLoad4LOD		CLT_TxtLoad4LOD
#define CLT_TXSRCTYPE01		CLT_TXTSRCTYPE01
#define CLT_TXSRCTYPE23		CLT_TXTSRCTYPE23
#define CLA_TXSRCTYPE01		CLA_TXTSRCTYPE01
#define CLA_TXSRCTYPE23		CLA_TXTSRCTYPE23
#define CLA_TXLDCNTL		CLA_TXTLDCNTL
#define CLT_TXLDCNTL		CLT_TXTLDCNTL
#define CLT_TXLODBASE0		CLT_TXTLODBASE0
#define CLT_TXLODBASE1		CLT_TXTLODBASE1
#define CLT_TXLODBASE2		CLT_TXTLODBASE2
#define CLT_TXLODBASE3		CLT_TXTLODBASE3
#define CLA_TXUVMAX		CLT_TXTUVMAX
#define CLT_TXUVMAX		CLT_TXTUVMAX
#define CLA_TXUVMASK		CLA_TXTUVMASK
#define CLT_TXUVMASK		CLT_TXTUVMASK


#endif /* __GRAPHICS_CLT_CLTMACROS_H */
