...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclVar.c,v 1.25 91/10/31 16:41:46 ouster Exp $ SPRITE (Berkeley)";
#endif
...
/*dprintf("Tcl_SetVar2: interp x%lx name1 '%.32s' name2 '%.32s' ", interp, name1, name2);*/
    /*
     * Lookup the first name.
     */
				 ...
				 * TCL_GLOBAL_ONLY or TCL_LEAVE_ERR_MSG. */
{
	...
	if (flags & TCL_LEAVE_ERR_MSG) {
	    VarErrMsg(interp, name1, name2, "set", 
