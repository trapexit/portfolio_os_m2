...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclUnixStr.c,v 1.11 92/01/03 08:28:54 ouster Exp $ SPRITE (Berkeley)";
#endif /* not lint */
...
#endif
#if defined(SIGXFSZ) && (!defined(SIGPWR) || (SIGXFSZ != SIGPWR))
...
#endif
#if defined(SIGXCPU) && (!defined(SIGEMT) || (SIGXCPU != SIGEMT))
