...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclParse.c,v 1.20 91/10/31 16:41:52 ouster Exp $ SPRITE (Berkeley)";
#endif
...
/* Dividing line between positive and negative... */
    ...
    TCL_SPACE,         TCL_COMMAND_END,   TCL_NORMAL,        TCL_NORMAL,
    TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,
    TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,
    TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,
    TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,        TCL_NORMAL,
...
/*dprintf("BRACE: [0]=x%02X'%c' x%lx -> <%.32s>  ", *src, *src, src, src);*/
    ...
    while (1) {
		...
		if (dst == end) {
			pvPtr->next = dst;
/*dprintf("BRACE: EXPAND  ", pvPtr->buffer, pvPtr->buffer);*/
    ...
    *dst = '\0';
/*dprintf("BRACE-END: buffer x%lx -> <%.32s>  ", pvPtr->buffer, pvPtr->buffer);*/
    pvPtr->next = dst;
    *termPtr = src;
    return TCL_OK;
	}
