...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclExpr.c,v 1.34 91/12/15 17:30:42 ouster Exp $ SPRITE (Berkeley)";
#endif
				 ...
				 * Caller must have initialized pv field. */
{
	...
	errno = 0;
	valuePtr->intValue = strtoul(string, &term, 0);
	c = *term;
	if ((c == '\0') && (errno != ERANGE)) {
	    return TCL_OK;
	}
